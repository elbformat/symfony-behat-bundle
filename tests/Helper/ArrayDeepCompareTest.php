...
#[CoversClass(ArrayDeepCompare::class)]
class ArrayDeepCompareTest extends TestCase
{
    ...
    public static function arrayContainsProvider(): array
    {
        return [
            [['a', 'b'], /* contains */ ['a']],
            [['a', 'b'], /* contains */ ['b']],
    ...
    public function testArrayContainsNot(array $container, array $containment, string $difference): void
    {
        $this->assertFalse($this->comp->arrayContains($container, $containment));
        $this->assertEquals($difference, $this->comp->getDifference());
    }

    public static function arrayContainsNotProvider(): array
    {
        return [
    ...
    public static function arrayEqualsProvider(): array
    {
        return [
            [['a'], /* equals */ ['a']],
            [['a', 'b'], /* equals */ ['b', 'a']],
    ...
    public function testArrayEqualsNot(array $container, array $containment, string $difference): void
    {
        $this->assertFalse($this->comp->arrayEquals($container, $containment));
        $this->assertEquals($difference, $this->comp->getDifference());
    }

    public static function arrayEqualsNotProvider(): array
    {
        return [
